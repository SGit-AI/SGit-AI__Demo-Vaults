...
|------|----------|-------|----------|----------|-----------|----------|----------|----------|---------------|
| `demo-vaults-catalogue` | The catalogue itself: app + data + every published archive — a vault listing vaults, including itself | application | production | reference | escrowed | `2a8d3n2z` | https://demos.sgit.ai | `e6136dab44fecf12b440d6f827419fcb5d51e244576116336c5bef0c42adaa1a` | 2026-08-16 |
| `field-notes-embed-demo` | The sgit.ai vault-app-embed demo: six small studies served as a vault app with a deliberately published read key | application | demonstration | copy | escrowed | `4bshby5n` | https://dev.send.sgraph.ai | `2848993a68c02a33ea5582902c391901191e53680d35b36c0e76185d4107ad81` | 2026-08-16 |
